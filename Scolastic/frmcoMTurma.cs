...
namespace Scolastic
{
    public partial class frmcoMTurma : Form
    {
        public frmcoMTurma()
        {
            InitializeComponent();
        ...
        private void frmcoMTurma_Load(object sender, EventArgs e)
        {
            ...
            VarGlobal.cd_ms_curso= Convert.ToInt32(dataGridView1[5, fila].Value.ToString());
        ...
        private void txtPesquisa_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                VarGlobal.cd_ms_curso = Convert.ToInt32(dataGridView1[5, dataGridView1.CurrentRow.Index].Value.ToString());
                VarGlobal.cd_ds_tur = Convert.ToInt32(txtCodTurma.Text);
